...
public class UpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Data data=new Data(ID,date,time,
				QSParam[1],QSParam[2],QSParam[3],QSParam[4],QSParam[5],QSParam[6],QSParam[7],QSParam[8],QSParam[9],
				QSParam[10],QSParam[11],QSParam[12],QSParam[13],QSParam[14],QSParam[15],QSParam[16],QSParam[17],QSParam[18],QSParam[19],
				QSParam[20],QSParam[21],QSParam[22],QSParam[23],QSParam[24],QSParam[25],QSParam[26],QSParam[27],QSParam[28],QSParam[29],
				QSParam[30],QSParam[31],QSParam[32],QSParam[33],QSParam[34],QSParam[35],QSParam[36],QSParam[37],QSParam[38],QSParam[39],
				QSParam[40],QSParam[41],QSParam[42],QSParam[43],QSParam[44],QSParam[45],QSParam[46],QSParam[47],QSParam[48],QSParam[49],
				QSParam[50],QSParam[51],QSParam[52],QSParam[53],QSParam[54],QSParam[55],QSParam[56],QSParam[57],QSParam[58],QSParam[59],
				QSParam[60],QSParam[61],QSParam[62],QSParam[63],QSParam[64],QSParam[65],QSParam[66],QSParam[67],QSParam[68],QSParam[69],
				QSParam[70],QSParam[71],QSParam[72],QSParam[73],QSParam[74],QSParam[75],QSParam[76],QSParam[77],QSParam[78],QSParam[79],
				QSParam[80],QSParam[81],QSParam[82],QSParam[83],QSParam[84],QSParam[85],QSParam[86],QSParam[87],QSParam[88],QSParam[89],
				QSParam[90],QSParam[91],QSParam[92],QSParam[93],QSParam[94],QSParam[95],QSParam[96],QSParam[97],QSParam[98],QSParam[99]
				);
		...
		avg=value1;
		if (value1>= value2 && value1<=value3)  // value1 is greater than 2 but less than 3
			avg=value1;
		if (value1>= value3 && value1<=value2)  // value1 is greater than 3 but less than 2
			avg=value1;
		if (value2>= value1 && value2<=value3)  // value2 is greater than 1 but less than 3
			avg=value2;
		if (value2>= value3 && value2<=value1)  // value2 is greater than 3 but less than 1
			avg=value2;
		if (value3>= value2 && value3<=value1)  // value3 is greater than 2 but less than 1
			avg=value3;
		if (value3>= value1 && value3<=value2)  // value3 is greater than 1 but less than 2
			avg=value3;
		String solarRadiationMin = ConvertDoubleToString(min);
		String solarRadiationAvg = ConvertDoubleToString(avg);
		String solarRadiationMax = ConvertDoubleToString(max);
		*/
